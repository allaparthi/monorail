...
feedback_email = 'suresh_allaparthi@dilettante.in'
...
send_all_email_to = 'suresh_allaparthi@dilettante.in'
...
send_local_email_to = (
    ...
    'suresh_allaparthi@dilettante.in')
...
send_email_as_format = 'suresh_allaparthi@dilettante.in'
send_noreply_email_as_format = 'suresh_allaparthi@dilettante.in'
...
db_master_name = 'skytran'
db_replica_names = ['skytran-replica']
...
default_access_level = project_pb2.ProjectAccess.MEMBERS_ONLY
...
group_creation_restriction = site_pb2.UserTypeRestriction.ANYONE
...
# pipeline.
alert_escalation_email = 'suresh_allaparthi@dilettante.in'

# Bugs autogenerated from alert emails are created through this account.
alert_service_account = 'suresh_allaparthi@dilettante.in'
